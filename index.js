...
exports.triggerDag = function triggerDag (event) {
  ...
  const PROJECT_ID = 'seu-projeto-nome-no-google';
  // Navigate to your webserver's login page and get this from the URL
  const CLIENT_ID = 'coloque-aqui-o-id-recuperado-da-execução-do-script-get_client_id.py';
  // This should be part of your webserver's URL:
  // {tenant-project-id}.appspot.com
  const WEBSERVER_ID = 'coloque-aqui-seu-id-recuperado-na-tela-de-detalhes-do-google-compose';
  // The name of the DAG you wish to trigger
  const DAG_NAME = 'coloque-aqui-o-nome-da-trigger-criada-no-google-compose';
