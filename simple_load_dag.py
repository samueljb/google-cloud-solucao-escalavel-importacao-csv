...
# file to.
COMPLETION_BUCKET = 'seu-projeto-nome-no-google-bucket-navi-out'
DS_TAG = '{{ ds }}'
...
DEFAULT_DAG_ARGS = {
    ...
    'email_on_retry': True,
    'retries': 1,
    'project_id': 'seu-projeto-nome-no-google',
    'dataflow_default_options': {
        'project': 'seu-projeto-nome-no-google',
        'temp_location': 'gs://seu-projeto-nome-no-google-bucket-navigation/tmp/',
...
with models.DAG(dag_id='raw-nav-data-composer',
    ...
    job_args = {
        ...
        'output': 'seu-projeto-nome-no-google:dataNavigationDataSet.RAW_DATA_NAVIGATION',
        'runner': 'DataflowRunner',
		'project': 'seu-projeto-nome-no-google',
